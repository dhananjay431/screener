              ...
              if ("table" != this.nodeName.toLowerCase())
                ...
                var F,
                  ...
                  N =
                    ...
                    c.oFeatures);
                if (
                  (e.bStateSave && (N.bStateSave = !0), void 0 === e.aaSorting)
                )
                ...
                var n = r.children("caption"),
                  n =
                    (c.caption &&
                      (n =
                        0 === n.length ? H("<caption/>").appendTo(r) : n).html(
                        c.caption,
                      ),
                    n.length &&
    ...
    t._hungarianMap || Z(t),
      H.each(n, function (e) {
        void 0 === (r = t._hungarianMap[e]) ||
          (!a && void 0 !== n[r]) ||
          ("o" === r.charAt(0)
            ? (n[r] || (n[r] = {}), H.extend(!0, n[r], n[e]), q(t[r], n[r], a))
            : (n[r] = n[e]));
      });
  }
  V.util = {
    ...
    if (null === c.nTr) {
      for (
        ...
        (!u &&
          ...
          i.fnCreatedCell &&
            i.fnCreatedCell.call(e.oInstance, o, B(e, t, l), d, t, l);
      }
    ...
    H.each(t, function (e, t) {
      ...
      null !== t &&
        ...
        (function e(t, n, a) {
          ...
          (function (e, t, n) {
            ...
            return ((a = { rowNum: t })[n] = { contents: [] }), e.push(a), a;
          })(o, n, a),
          a,
          t,
        );
      ...
      o.sort(function (e, t) {
        var n = e.rowNum,
          a = t.rowNum;
        return n === a
          ? ((e = e.full && !t.full ? -1 : 1), "bottom" === r ? -1 * e : e)
          : a - n;
      }),
      "bottom" === r && o.reverse();
          ...
          error: function (e, t) {
            -1 === G(n, null, "xhr", [n, null, n.jqXHR], !0).indexOf(!0) &&
              ("parsererror" == t
                ...
                : 4 === e.readyState && $(n, 0, "Ajax error", 7)),
              w(n, !1);
          },
        });
  ...
  function Be(t) {
    ...
    if (t.scrollBarVis !== f && void 0 !== t.scrollBarVis)
      ...
      a.find("colgroup").remove(),
        ...
        c && (l.find("colgroup").remove(), l.append(t.colgroup.clone())),
  ...
  function Ke(n, e, t) {
    ...
    if (e && e.time) {
      ...
      if (0 < l && e.time < +new Date() - 1e3 * l) n._bLoadingState = !1;
        ...
        -1 !== G(n, "aoStateLoadParams", "stateLoadParams", [n, e]).indexOf(!1)
      )
        n._bLoadingState = !1;
  ...
  function et(e, t, n) {
    ...
    for (r in t)
      Object.prototype.hasOwnProperty.call(t, r) &&
        ((a = t[r]),
        H.isPlainObject(a)
          ? (H.isPlainObject(e[r]) || (e[r] = {}), H.extend(!0, e[r], a))
        ...
        : this.iterator(
            ...
            function (e) {
              var t = H(e.nTable),
                ...
                a = H(e.nTableWrapper);
              n.length ||
                ((n = H("<caption/>").html(r)), (e.captionNode = n[0]), o) ||
  ...
  function gt(t, n) {
    return function (e) {
      return (
        T(e) ||
          "string" != typeof e ||
          ((e = e.replace(F, " ")), t && (e = L(e)), n && (e = k(e, !1))),
        e
      );
    };
  }
            ...
            return (
              (t = st(
                ...
                function (n) {
                  ...
                  if (((i = i || vt(r, o)), null !== e && -1 !== i.indexOf(e)))
                    return [e];
            ...
            this.iterator("table", function (e) {
              _e(e, e.aoHeader),
                ...
                t.iterator("column", function (e, t) {
                  r.includes(t) &&
                    G(e, null, "column-visibility", [e, t, n, a]);
                }),
                  ...
                  : "sort" === t
                    ...
                    : ((e =
                        null === r
                          ...
                          : wt(n, "format", "toFormat", "toISOString", r)),
                      "display" === t ? u(e) : e)
          );
        }
      );
        ...
        function n() {
          !(function e(t, n, a) {
            ...
            h.length &&
              ...
              e(t, n, H.extend({}, a, { buttons: a.buttons - 2 }));
          })(e, a.children(), t);
        }
        var a = H("<div/>")
          .addClass(
          ...
          .append("<nav>");
        return (
          e.aoDrawCallback.push(n), H(e.nTable).on("column-sizing.dt.DT", n), a
        );
      },
      "p",
    );
  ...
  return (
    V.feature.register(
      ...
      function (a, e) {
        ...
        e = H.extend({ menu: a.aLengthMenu, text: a.oLanguage.sLengthMenu }, e);
